...
```{r boxplot_function}
## Função para criar um boxplot.
## Esta função recebe 2 strings, o nome da coluna e o rótulo do eixo y.
cria_boxplot <- function(vinhos, coluna, rotulo) {
  ...
  ggplot(
    vinhos_2_colunas,
    aes_string(y = colnames(vinhos_2_colunas)[2], fill = "type")
  ) +
    geom_boxplot() +
    labs(y = rotulo) +
    ...
    scale_fill_manual(
      values = c("Tintos" = "#670067", "Brancos" = "#006700")
    )
